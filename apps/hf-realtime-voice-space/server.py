...
WAKE_WORD_FOLLOWUP_S = _bounded_int_env("WAKE_WORD_FOLLOWUP_S", 60, 5, 120)
WAKE_WORD_SCORE = _bounded_float_env("WAKE_WORD_SCORE", 2.5, 0.0, 10.0)
WAKE_WORD_THRESHOLD = _bounded_float_env("WAKE_WORD_THRESHOLD", 0.10, 0.01, 0.99)
