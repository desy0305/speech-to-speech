...
class ModuleArguments:
    ...
    tts: Optional[Literal["melo", "chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "ani-voice"]] = field(
        default="qwen3",
        metadata={
            "help": "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', or 'ani-voice'. Default is 'qwen3'."
        },
    )
    log_level: str = field(
        default="info",
